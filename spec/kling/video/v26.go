...
// SchemaV26Video returns the InputSchema fields for kling-v2-6 through v2-9.
func SchemaV26Video() []xai.Field {
	return []xai.Field{
		...
		{Name: internal.ParamImageUrl, Kind: types.String},
		{Name: internal.ParamVideoUrl, Kind: types.String},
		{Name: internal.ParamCharacterOrientation, Kind: types.String},
		{Name: internal.ParamKeepOriginalSound, Kind: types.String},
	}
}
