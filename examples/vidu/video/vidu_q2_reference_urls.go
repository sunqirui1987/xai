...
func runViduQ2ReferenceToVideoURLs(ctx context.Context, svc *vidu.Service, model xai.Model) error {
	...
	results, err := xai.Call(ctx, svc, op, newViduOptions(svc, "demo-user-q2-ref-urls"), progressPrinter("q2-ref-urls"))
	if err != nil {
		return err
	}
