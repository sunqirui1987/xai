...
func TestGetAsset(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`{"success":true,"data":{"Id":"asset_789xyz","GroupId":"grp_abc123","Name":"女性正脸-01","Type":"Image","Status":"Active","Url":"https://tos.example.com/a.jpg","CreateTime":"2026-04-05T14:30:00Z"}}`))
	}))
	defer srv.Close()
