...
func runViduQ3ImageToVideoTurbo(ctx context.Context, svc xai.Service, model xai.Model) error {
	...
	results, err := xai.Call(ctx, svc, op, newViduOptions(svc, "demo-user-q3-image-turbo"), progressPrinter("q3-image-turbo"))
	if err != nil {
		return err
	}
