...
func runViduQ3StartEndToVideoPro(ctx context.Context, svc xai.Service, model xai.Model) error {
	...
	results, err := xai.Call(ctx, svc, op, newViduOptions(svc, "demo-user-q3-start-end-pro"), progressPrinter("q3-start-end-pro"))
	if err != nil {
		return err
	}
