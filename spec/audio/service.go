...
// AudioService returns self. Provider wrappers (e.g. *qiniu.Service) expose the
// embedded *Service through the same method so Operation.Call can unwrap them.
func (s *Service) AudioService() *Service { return s }
